...
log.warning("ENJOY MODDING !!")
    ...
    INTRXDUCE = gui.get_tab("UTHENSIA BY INTRXDUCE")
    INTRXDUCE:add_text("                      UTHENSIA MENU 1.70 ")
    INTRXDUCE:add_text("                          I N T R X D U C E ")


    moneymethods = INTRXDUCE:add_tab("MONEY METHODS")
    ranksmenu = INTRXDUCE:add_tab("RANKS")
    unlocks = INTRXDUCE:add_tab("UNLOCKS")


    
VehiclesMenu = INTRXDUCE:add_tab("VEHICLE MENU")

VehiclesMenu:add_button("ENABLE REMOVED VEHICLES", function()
    ...
    MissionEdit = INTRXDUCE:add_tab("MISSION EDITOR")

    MissionEdit:add_button("REMOVE DAX FOOLIGAN MISSIONS ", function()
	stats.set_int(MPX() .. "XM22JUGGALOWORKCDTIMER", -1)
end)

MissionEdit:add_button("REMOVE VIP/MC COOLDOWN", function()
	stats.set_int("MPPLY_VIPGAMEPLAYDISABLEDTIMER", 0)
end)

MissionEdit:add_button("SKIP YACHT MISSIONS", function()
...
MissionEdit:add_separator()
    ...
    RankEditor:add_button("SET RANK", function()
    ...
    CrewRankEditor:add_text("SET YOUR CREW RANK TO:")
    
    local rankLevel = CrewRankEditor:add_input_int("RANK")
    
    CrewRankEditor:add_button("SET CREW RANK", function()
        local levelValue = rankLevel:get_value()
    ...
    LatestUnlock = unlocks:add_tab("UNLOCK EVERYTHING")
    LSCMUnlocker = unlocks:add_tab("LSCM UNLOCKER")
    ...
    LatestUnlock:add_button("TIME RELATED STATS", function()
        ...
        gui.show_message(
			"UNLOCKER",
			"TIME RELATED STATS ARE NOW UNLOCKED"
)
    end)
    LatestUnlock:add_separator()
